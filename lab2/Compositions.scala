...
object Compositions {
  ...
  def main(args: Array[String]): Unit = {
    val num: Int = 1
    println(Compositions.testCompose((num:Int) => num + 1)((num:Int)=>num * num)((num:Int)=>num * 2)(num))
    println(Compositions.testMapFlatMap((num:Int) => Some(num + 1))((num:Int)=>Some(num * num))((num:Int)=>num * 2)(Some(num)))
    println(Compositions.testForComprehension((num:Int) => Some(num + 1))((num:Int)=>Some(num * num))((num:Int)=>num * 2)(Some(num)))
  }
}